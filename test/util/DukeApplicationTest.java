...
public class DukeApplicationTest extends ApplicationTest {
    ...
    protected Runnable pushRunnable(Scene scene, int x, int y) {
        return () -> scene.getOnMousePressed().handle(new MouseEvent(MouseEvent.MOUSE_CLICKED, x, y, x, y, MouseButton.PRIMARY, 1,
                false, false, false, false, true, false, false, true, false, false, null));
    }
